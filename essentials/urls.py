...
urlpatterns = [
	...
	url(r'^cryptothlon/prelims/j7oEkC4hdpLEZKvPz6IC/$', registration.views.cryptothlonPrelims , name="cryptothlonPrelims"),
	...
	url(r'^open_quizzes/$', views.openQuizzes , name="openQuizzes"),
